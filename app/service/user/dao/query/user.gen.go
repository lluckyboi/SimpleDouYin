...
func newUser(db *gorm.DB) user {
	...
	_user.UserTrueName = field.NewString(tableName, "user_true_name")
	_user.UserNickName = field.NewString(tableName, "user_nick_name")
	_user.Sex = field.NewString(tableName, "sex")
	_user.UserSchool = field.NewString(tableName, "user_school")
	_user.UserStno = field.NewString(tableName, "user_stno")
	_user.UserRole = field.NewString(tableName, "user_role")
	_user.UserPnum = field.NewString(tableName, "user_pnum")
	_user.UserPassword = field.NewString(tableName, "user_password")
	_user.CreatTime = field.NewTime(tableName, "creatTime")
...
type user struct {
	...
	ALL          field.Field
	UserTrueName field.String
	UserNickName field.String
	Sex          field.String
	UserSchool   field.String
	UserStno     field.String
	UserRole     field.String
	UserPnum     field.String
	UserPassword field.String
	CreatTime    field.Time
...
func (u *user) updateTableName(table string) *user {
	...
	u.UserTrueName = field.NewString(table, "user_true_name")
	u.UserNickName = field.NewString(table, "user_nick_name")
	u.Sex = field.NewString(table, "sex")
	u.UserSchool = field.NewString(table, "user_school")
	u.UserStno = field.NewString(table, "user_stno")
	u.UserRole = field.NewString(table, "user_role")
	u.UserPnum = field.NewString(table, "user_pnum")
	u.UserPassword = field.NewString(table, "user_password")
	u.CreatTime = field.NewTime(table, "creatTime")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["user_true_name"] = u.UserTrueName
	u.fieldMap["user_nick_name"] = u.UserNickName
	u.fieldMap["sex"] = u.Sex
	u.fieldMap["user_school"] = u.UserSchool
	u.fieldMap["user_stno"] = u.UserStno
	u.fieldMap["user_role"] = u.UserRole
	u.fieldMap["user_pnum"] = u.UserPnum
	u.fieldMap["user_password"] = u.UserPassword
	u.fieldMap["creatTime"] = u.CreatTime
