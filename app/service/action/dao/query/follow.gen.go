...
func newFollow(db *gorm.DB) follow {
	...
	_follow.TargetUID = field.NewInt64(tableName, "target_uid")
...
type follow struct {
	...
	ALL       field.Asterisk
	UID       field.Int64 // 关注者id
	TargetUID field.Int64 // 被关注者id
...
func (f *follow) updateTableName(table string) *follow {
	...
	f.TargetUID = field.NewInt64(table, "target_uid")
...
func (f *follow) fillFieldMap() {
	...
	f.fieldMap["target_uid"] = f.TargetUID
}
