...
type FollowerLostLogic struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
	logx.Logger
}

func NewFollowerLostLogic(ctx context.Context, svcCtx *svc.ServiceContext) *FollowerLostLogic {
	return &FollowerLostLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
...
func (l *FollowerLostLogic) FollowerLost(in *pb.FollowerListReq) (*pb.FollowerListResp, error) {
	resp := new(pb.FollowerListResp)
